...
class Quote(models.Model):
    quote = models.CharField(max_length=400, null=True, blank=True, default=None)
    last_name = models.CharField(max_length=40, null=True, blank=True, default=None)
    for_name = models.CharField(max_length=40, null=True, blank=True, default=None)
    nick_name = models.CharField(max_length=40, null=True, blank=True, default=None)
    desc_author = models.CharField(max_length=40, null=True, blank=True, default=None)
    date = models.CharField(max_length=40, null=True, blank=True, default=None)
    header = models.CharField(max_length=20, null=True, blank=True, default=None)
    quote_type = models.ForeignKey(
        "QuoteType", blank=True, null=True, default=None, on_delete=models.CASCADE
    )
