...
urlpatterns = [
    ...
    # ----------------------------
    re_path(r'room-preference/(?P<tutor>\w{2,8})?/',
            views.room_preference, name='room-pref'),
    ...
    re_path(r'^roomreservation/(?P<dept>\w{2,15})?/', views.room_reservation, name='roomreservation'),
    ...
    path('fetch_constraints/',
         views.fetch_constraints, name="fetch_constraints"),
    path('fetch_course_types/',
    ...
    path('change_user_pref/<yyyy:year>/<int:week>/<str:username>/',
         views.user_preferences_changes,
         name="user_pref_changes"),
    path('change_course_pref/<yyyy:year>/<int:week>/<str:train_prog>/'
         '<str:course_type>/',
         views.course_preferences_changes, name="course_pref_changes"),
    path('change_room_pref/<yyyy:year>/<int:week>/<str:room>/',
    ...
    path('change_room_pref_per_tutor/<str:tutor>/',
