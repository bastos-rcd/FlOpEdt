...
class FirstDepartmentTestCase(TestCase):
    ...
    def setUpTestData(cls):
        cls.tp1 = models.TrainingProgramme.objects.create(
            name="TrainingProgramme1", abbrev="tp1"
        )
        cls.tp2 = models.TrainingProgramme.objects.create(
            name="TrainingProgramme2", abbrev="tp2"
        )
        cls.edt_version_1 = models.TimetableVersion.objects.create(
            week=1, year=2018, version=0
        )
        cls.edt_version_2 = models.TimetableVersion.objects.create(
            week=2, year=2018, version=0
        )
...
class TimetableVersionTestCase(TestCase):
    def setUp(self):
        ...
        self.edt2 = models.TimetableVersion.objects.create(
            department=self.d1, week=40, year=2018, version=2
        )
    ...
    def test_get_version_multiple_objects_exist(self):
        self.edt3 = models.TimetableVersion.objects.create(
            department=self.d1, week=40, year=2018, version=2
        )
...
class ScheduledCourseTestCase(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.department1 = models.Department.objects.create(
            name="departement1", abbrev="dept1"
        )
        cls.department2 = models.Department.objects.create(
            name="departement2", abbrev="dept2"
        )
        cls.tp1 = models.TrainingProgramme.objects.create(
            name="TrainingProgramme1", abbrev="tp1", department=cls.department1
        )
        cls.tp2 = models.TrainingProgramme.objects.create(
            name="TrainingProgramme2", abbrev="tp2", department=cls.department2
        )
        cls.gt1 = models.GroupType.objects.create(
            name="group_type_1", department=cls.department1
        )
        cls.g1 = models.StructuralGroup.objects.create(
            name="gp1", train_prog=cls.tp1, type=cls.gt1, size=0
        )
        cls.ct1 = models.CourseType.objects.create(name="CourseType1")
        cls.m1 = models.Module.objects.create(
            name="module1", abbrev="m1", train_prog=cls.tp1, period=cls.p1
        )
        cls.c1 = models.Course.objects.create(
            group=cls.g1, week=39, year=2018, type=cls.ct1, module=cls.m1
        )
        cls.p1 = models.TrainingPeriod.objects.create(
            name="annee_complete", starting_week=0, ending_week=53
        )
