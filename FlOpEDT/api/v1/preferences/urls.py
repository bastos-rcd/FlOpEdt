...
routerPreferences.register(r'room-singular', views.RoomPreferenceSingularViewSet, basename="room-single")
routerPreferences.register(r'room-actual', views.RoomPreferenceActualViewSet, basename="room-actual")
