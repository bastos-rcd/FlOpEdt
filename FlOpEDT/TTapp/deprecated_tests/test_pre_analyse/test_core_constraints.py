...
class ConsiderTutorsUnavailabilityTestCase(ConstraintTestCase):
    ...
    def setUp(self):
        ...
        self.constraint_dep_2 = ConsiderTutorsUnavailability.objects.get(
            department=self.dep_2
        )
    ...
    def test_consider_tutor_unavailability_in_all_departments(self):
        ...
        json_response_dict_default_dep = self.constraint_default_dep.pre_analyse(
            week=self.week_4_2022
        )
        json_response_dict_dep_2 = self.constraint_dep_2.pre_analyse(
            week=self.week_4_2022
        )
        self.assertJsonResponseIsKO(
            "6.1", json_response_dict_default_dep
        ...
        json_response_dict_default_dep = self.constraint_default_dep.pre_analyse(
            week=self.week_6_2022
        )
        json_response_dict_dep_2 = self.constraint_dep_2.pre_analyse(
            week=self.week_6_2022
        )
        self.assertJsonResponseIsOK(
            "7.1", json_response_dict_default_dep
...
class NoSimultaneousGroupCoursesTestCase(ConstraintTestCase):
    ...
    def setUp(self):
        ...
        self.constraint_dep_2 = NoSimultaneousGroupCourses.objects.get(
            department=self.dep_2
        )
