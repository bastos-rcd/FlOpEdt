...
class ConstraintType(Enum):
    ...
    IBD_EQ = "IBD égal"
    FORCED_TBD = "forced tutor busy day"
    ...
    MODULE_TUTOR_REPARTITION = "Module Tutor Repartition"
    ...
    STABILIZE_THROUGH_PERIODS = "Stabilization through periods"
    ...
    UNDESIRED_SLOTS_LIMIT = "Undesired slots limit"
    ...
    NO_GROUP_COURSE_ON_WEEKDAY = "NO_GROUP_COURSE_ON_WEEKDAY"
    NO_TUTOR_COURSE_ON_DAY = "NO_TUTOR_COURSE_ON_DAY"
    LOWER_BOUND_BUSY_DAYS = "Lower bound busy days"
    GROUPS_LUNCH_BREAK = "GROUPS_LUNCH_BREAK"
    TUTORS_LUNCH_BREAK = "TUTORS_LUNCH_BREAK"
    BREAK_AROUND_COURSE = "BREAK_AROUND_COURSE"
    AVOID_BOTH_TIME_SAME_DAY = "AVOID_BOTH_TIME_SAME_DAY"
    LIMIT_SIMULTANEOUS_COURSES_NUMBER = "LIMIT_SIMULTANEOUS_COURSES_NUMBER"
    NOT_ALONE = "NOT_ALONE"
    TRAIN_PROG_FORBIDDEN_SLOT = "TRAIN_PROG_FORBIDDEN_SLOT"

    # From Cosmo
    MINIMIZE_BUSY_DAYS = "Minimize Busy Days"
    JOURS_DE_REPOS_PAR_SEMAINE = "Jours de repos par semaine"
    COSMO = "Cosmo - to be defined"
    LIMIT_BUSY_SLOTS = "Limit Busy Slots"
    MODULE_BY_BLOC = "Module by Bloc"
    MAX_TIME_PER_WEEK = "Max time per week"
    MIN_TIME_PER_WEEK = "Min time per week"
    ASSEZ_DE_QUASI_WE = "Assez de quasi-WE libres"
    ...
    MAX_HOLES = "MAX_HOLES"
    MAX_TIME_PER_PERIOD = "MAX_TIME_PER_PERIOD"
    MIN_TIME_PER_PERIOD = "MIN_TIME_PER_PERIOD"
