...
urlpatterns = [
    path('side_panel/<yyyy:year>/<ww:week>/',
         TTapp.views.available_work_copies,
         name="available_work_copies"),
    path('check_swap/<yyyy:year>/<ww:week>/<int:work_copy>/',
         TTapp.views.check_swap,
         name="check_swap"),
    path('swap/<yyyy:year>/<ww:week>/<int:work_copy>/',
         TTapp.views.swap,
         name="swap"),
    path('delete_work_copy/<yyyy:year>/<ww:week>/<int:work_copy>/',
         TTapp.views.delete_work_copy,
         name="delete_work_copy"),
    path('duplicate_work_copy/<yyyy:year>/<ww:week>/<int:work_copy>/',
         TTapp.views.duplicate_work_copy,
         name="duplicate_work_copy"),
    path('delete_all_unused_work_copies/<yyyy:year>/<ww:week>/',
         TTapp.views.delete_all_unused_work_copies,
         name="delete_all_unused_work_copies"),
    path('reassign_rooms/<yyyy:year>/<ww:week>/<int:work_copy>/',
         TTapp.views.reassign_rooms,
         name="reassign_rooms"),
    path('duplicate_in_other_weeks/<yyyy:year>/<ww:week>/<int:work_copy>/',
