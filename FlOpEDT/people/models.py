...
class TutorPreference(models.Model):
    ...
    pref_hours_per_day = models.PositiveSmallIntegerField(
        verbose_name="How many hours per day would you prefer ?", default=4
    )  # FIXME : time with TimeField or DurationField
    max_hours_per_day = models.PositiveSmallIntegerField(
        verbose_name="How many hours per day can you suffer ?", default=9
    )  # FIXME : time with TimeField or DurationField
...
class PhysicalPresence(models.Model):
    ...
    week = models.ForeignKey(
        "base.Week", on_delete=models.CASCADE, null=True, blank=True
    )
